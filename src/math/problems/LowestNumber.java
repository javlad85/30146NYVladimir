...
public class LowestNumber {
    ...
    public static void main(String[] args) {
         ...
         */
        int array[] = new int[]{211, 110, 99, 34, 66, 89, 67, 456, 321, 456, 78, 90, 45, 39, 56, 78, 90, 54, 32, 123, 67, 5, 679, 54, 32, 65};
        LowestNumber.LowestNumber(array);
        System.out.println(LowestNumber.LowestNumber(array));
